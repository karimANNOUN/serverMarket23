...
module.exports.register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, hashedPassword, users, userRepository, token, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, data_source_1.AppDataSource.getRepository(User_1.User).findOneBy({
            ...
            case 3:
                _a.sent();
                token = jwt.sign({ users: users }, 'kimou', { expiresIn: '7d' });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                token = jwt.sign({ user: user }, 'kimou', { expiresIn: '7d' });
...
module.exports.user = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        user = req.user;
